    ...
    <>
      ...
      <div className=".tanD1">
        ...
        <div className="tLocation">
          <div className="BSS">Popular localities in and around Hyderabad</div>
        </div>
        <div className="Lol">
          <div className="LolD">
            {" "}
            <p> Hitech-city (340 places)</p>
          </div>
          <div className="LolD">
            {" "}
            <p> Jubilee Hills (41 places)</p>
          </div>
          <div className="LolD">
            {" "}
            <p> Banjara Hills (31 places)</p>
          </div>
          <div className="LolD">
            {" "}
            <p> Khajaguda (128 places)</p>
          </div>
          <div className="LolD">
            {" "}
            <p> Green Hills (26 places)</p>
          </div>
          <div className="LolD">
            {" "}
            <p> Madhapur (46 places)</p>
          </div>
          <div className="LolD">
            {" "}
            <p> Necklace road (207 places)</p>
          </div>
          <div className="LolD">
            {" "}
            <p> Kukatpally (41 places)</p>
          </div>
          <div className="LolD">
            {" "}
            <p> Miyapur (32 places)</p>
          </div>
          <div className="LolD">
            {" "}
            <p> Kondapur (36 places)</p>
          </div>
          <div className="LolD">
            {" "}
            <p> Manikonda (95 places)</p>
          </div>
          <div className="LolD">
            {" "}
            <p> Narsing (69 places)</p>
          </div>
        </div >
